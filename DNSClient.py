...
real_name_server = '8.8.8.8' #Google # Research public DNS servers to find a valid DNS server IP address to use
...
def query_local_dns_server(domain,question_type):
    ...
    resolver.nameservers = [local_host_ip] #local DNS server
